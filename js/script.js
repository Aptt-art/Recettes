...
// Toggle sous-menu catégories dans le menu burger
document.querySelector('.categories').addEventListener('click', function(e) {
    e.stopPropagation(); // Empêche le clic sur le lien de fermer le menu
...
//         fetch(`./search_recipes.php=${encodeURIComponent(query)}&page=${page}`)
